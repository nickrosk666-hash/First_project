...
ФОРМАТИРОВАНИЕ: Пиши plain text. Никаких звёздочек, решёток, дефисов-списков, блоков кода в тройных кавычках. Списки нумеруй цифрами (1. 2. 3.). Пиши как в мессенджере.`;
